...
mpirun -n $procs ./spmv_random "input/cnr_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/eu_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/in_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/NACA0015_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/road_usa_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/road_central_random_"$procs".mtx"
mpirun -n $procs ./spmv_random "input/nlpkkt120_random_"$procs".mtx"
...
mpirun -n $procs ./spmv_random "input/uk2002_random_"$procs".mtx"
#mpirun -n $procs ./spmv_random "input/uk2007_random_"$procs".mtx"
...
mpirun -n $procs ./spmv_random "input/citationCiteseer_random_"$procs".mtx"
